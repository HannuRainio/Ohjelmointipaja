...
public class FightingPitEnvController : MonoBehaviour
{

    [System.Serializable]
    public class PlayerInfo
    {
        public PushFighterAgent Agent;
        [HideInInspector]
    ...
    private Dictionary<PushFighterAgent, PlayerInfo> m_PlayerDict = new Dictionary<PushFighterAgent, PlayerInfo>();
    public bool UseRandomAgentRotation = true;
    public bool UseRandomAgentPosition = true;
    PushFighterSettings m_PushBlockSettings;
    ...
    void Start()
    {
        ...
        m_PushBlockSettings = FindObjectOfType<PushFighterSettings>();
    ...
    public void TouchedHazard(PushFighterAgent agent)
    {
    ...
    public void KilledByBaddie(PushFighterAgent agent, Collision baddieCol)
    {
