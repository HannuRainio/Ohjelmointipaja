...
namespace FightingPit
{
	public class FightingPitEnvController : MonoBehaviour
	{
	    ...
	    private Dictionary<FighterAgent, PlayerInfo> m_PlayerDict = new Dictionary<FighterAgent, PlayerInfo>();
	    public bool UseRandomAgentRotation = true;
	    public bool UseRandomAgentPosition = true;
	    FighterSettings m_PushBlockSettings;
	    ...
	    public void KilledByBaddie(FighterAgent agent, Collision baddieCol)
	    {
