...
public class GameInitScript : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        //GUI.DrawTexture(new Rect(0,0,Screen.width/10, Screen.height/10), logo);
        
        GUI.DrawTexture(new Rect(width / 8, height / 3, 3 * width / 4, height / 3), logo, ScaleMode.ScaleToFit, true, 0);
